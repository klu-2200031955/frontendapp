  ...
  return (
    <div>
      ...
      <div className={styles['frame22']}>
          ...
          <Link className={styles['text21']} to="/studenthome/studentonlineclasses">Online Classes</Link>
          <Link className={styles['text23']} to="/studenthome/studentchangepassword">Change Password</Link>
        </div>
        <Routes>
